...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HULUWA', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一只青蛙的自留地，还有一只叫灰圆的猫', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-coral-delta.vercel.app/', // 网站地址
