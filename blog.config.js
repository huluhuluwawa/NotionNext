...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '27c57ad06156810b8e47fe77d6d62776',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'maxine', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一只蛙和一只叫灰圆的猫', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-liart-ten.vercel.app/', // 网站地址
